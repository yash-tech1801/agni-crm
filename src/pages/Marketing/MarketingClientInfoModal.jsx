...
export default function MarketingClientInfoModal({ client, onClose }) {
    ...
    >
      ...
      >
        ...
        <div style={{ padding: 24 }}>
          ...
          >
            <div className="mkt-subcard">
              <div style={{ fontSize: 11, color: "#64748b", fontWeight: 600 }}>Total Invoiced Value</div>
            ...
            <div className="mkt-subcard">
              ...
              <div style={{ fontSize: 15, fontWeight: 700, marginTop: 4 }}>
                {client.salesPerson || "Marketing Lead"}
              </div>
              <div style={{ fontSize: 11, color: "#64748b", marginTop: 2 }}>
          ...
          {/* Section 1: Marketing Service Information */}
          <div style={{ marginBottom: 20 }}>
            <h4 style={{ margin: "0 0 10px", fontSize: 14, fontWeight: 700 }}>
              Marketing Service Request Details
            </h4>
            <div
            ...
            >
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span style={{ fontSize: 15, fontWeight: 700 }}>
                  {client.serviceName || "Enterprise Marketing Retainer"}
                </span>
                <span
                  className="mkt-badge"
                  style={{
              ...
              <p className="mkt-desc" style={{ marginTop: 8 }}>
                {client.notes || "Comprehensive marketing execution, conversion tracking, and campaign optimization agreement."}
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mkt-subcard">
              <div style={{ display: "flex", justifyContent: "space-between", padding: "6px 0", borderBottom: "1px solid rgba(255, 255, 255, 0.06)" }}>
                <span style={{ color: "#64748b" }}>Base Retainer Fee</span>
